...
use crate::filtering::{build_exclude_regex, build_include_regex, should_display_line};
use crate::highlighting::{apply_highlighting, get_highlight_rules, HighlightRule};
